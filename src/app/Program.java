...
public class Program {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.printf("Prestação: %.2f%n", f1.quotal());
		}
		catch (IllegalArgumentException e) {
			throw new IllegalArgumentException("Erro no financiamento 1: " + e.getMessage());
		}
		...
		try {
			...
			System.out.printf("Prestação: %.2f%n", f2.quotal());
		}
		catch (IllegalArgumentException e) {
			throw new IllegalArgumentException("Erro no financiamento 2: " + e.getMessage());
		}
	}
}
